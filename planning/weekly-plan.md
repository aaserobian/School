# School + Intake Studio: the weekly plan
...
Start from 168 hours and take out what is not negotiable.
...
- 8 hours of sleep.
- Sunday from noon is off.
- Friday evening is off.
- 3 or 4 exercise sessions a week.
- One meal a day away from every screen.

### Warning signs

Check these at the Sunday review.
...
3. **Three signs, or you are ill:** take the whole weekend off, tell your program if work is
   slipping, and restart at the following Sunday review.
...
3. Pick next week's three business outcomes and the study focus.
4. Look for exams or deadlines within two weeks. Switch to exam-week mode if one is close.
5. Put anything newly fixed (appointments, deadlines) on the calendar.

## When to revisit this plan

- A client books regular calls. The business blocks move to client hours, and the study
  blocks shuffle around them.
- The exam calendar lands. Mark the exam weeks now so the flip is not a surprise.
- The same warning sign shows up at three reviews in a row. The plan is wrong, not you.

If you want the grid as recurring blocks in your calendar, that is a ten-minute job from this
document.
